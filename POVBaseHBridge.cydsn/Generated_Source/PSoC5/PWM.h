...
#define PWM_INIT_COMPARE_VALUE2        (450u)
...
#define PWM_DEFAULT_COMPARE2_MODE      (uint8)((uint8)3u <<  PWM_CTRL_CMPMODE2_SHIFT)
#define PWM_DEFAULT_COMPARE1_MODE      (uint8)((uint8)1u <<  PWM_CTRL_CMPMODE1_SHIFT)
#define PWM_INIT_DEAD_TIME             (9u)
